...
public class JdbcFilmRepository implements FilmRepository {
    ...
    public void setLike(Long filmId, Long userId) {
        final String INSERT_QUERY = "INSERT INTO FILMLIKES (FILM_ID,USER_ID) " +
                "VALUES(:f_id,:u_id)";
        MapSqlParameterSource mapSqlParameterSource = new MapSqlParameterSource();
        mapSqlParameterSource.addValue("f_id", filmId);
    ...
    public void deleteLike(Long filmId, Long userId) {
        final String DELETE_QUERY = "DELETE FROM FILMLIKES WHERE FILM_ID = :f_id AND USER_ID = :u_id";
        MapSqlParameterSource mapSqlParameterSource = new MapSqlParameterSource();
        mapSqlParameterSource.addValue("f_id", filmId);
        mapSqlParameterSource.addValue("u_id", userId);
    ...
    private boolean checkExistFILMLIKES(Long filmId, Long userId) {
        boolean ret = false;
        final String SELECT_QUERY = "SELECT count(*) FROM FILMLIKES WHERE FILM_ID = :f_id AND USER_ID = :u_id";
    ...
    public Collection<Film> findPopular(int count) {
        final String SELECT_QUERY = "SELECT f.FILM_ID as f_id, f.FILM_NAME as f_name,f.DESCRIPTION as f_descr,f.RELEASE_DATE as f_rDate,f.DURATION as f_dur," +
                ...
                " FROM FILMS AS f" +
                " INNER JOIN  FILMLIKES as fl ON f.FILM_ID = fl.FILM_ID" +
