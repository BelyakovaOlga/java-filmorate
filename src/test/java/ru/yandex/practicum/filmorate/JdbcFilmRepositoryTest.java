...
public class JdbcFilmRepositoryTest {
    ...
    public void shouldReturnFilmById() {
        Optional<Film> userOptional = filmRepository.findById(1L);
    ...
    public void shouldCreateFilm() {
        Film filmNew = filmRepository.create(createTestFilm(0L));
    ...
    public void shouldUpdateFilm() {
        ...
        filmRepository.update(filmNewName);
        filmOptional = filmRepository.findById(1L);
